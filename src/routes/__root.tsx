  ...
  head: () => ({
    meta: [
      ...
      { title: "Aria — AI Workplace Productivity Assistant" },
      {
        name: "description",
        content:
          "Aria is your AI workplace copilot — chat, summarize documents, draft emails, recap meetings, and automate tasks.",
      },
      ...
      { property: "og:title", content: "Aria — AI Workplace Productivity Assistant" },
      {
        ...
        content:
          "Automate emails, summaries, meetings and tasks with an AI assistant built for work.",
      },
